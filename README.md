...
![Image](https://github.com/user-attachments/assets/99c6d6c2-b481-4287-9a8c-c81d95629830)
...
```bash
git clone https://github.com/Burak599/cifar100-effnetv2s-90.20acc-mobile-inference.git
...
```bash
python ModelLastTest/Code/best_model_Test.py
```
