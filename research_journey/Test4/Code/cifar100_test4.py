...
BASE_PATH = "/home/burak/cifar100-effnetv2-90.20acc-mobile-inference/research_journey/Test4"
...
CHECKPOINT_SAVE_PATH = os.path.join(WEIGHTS_DIR, "user_best_model_4.pth")

# 2. FINAL_MODEL_SAVE_PATH: Saves only the model state_dict after the final epoch.
FINAL_MODEL_SAVE_PATH = os.path.join(WEIGHTS_DIR, "user_last_epochs_4.pth")

# 3. PLOT_SAVE_PATH: The file path where the training and validation Accuracy/Loss curves will be saved.
PLOT_SAVE_PATH = os.path.join(PLOT_DIR, "user_training_history_plot_4.png")
# --------------------------
...
def main():
    ...
    # MixUp alpha=0.8 enables soft label blending between pairs of training samples
    # CutMix alpha=0.0 means CutMix is disabled for this run
    mixup_fn = Mixup(
    ...
    log_dir = os.path.join(BASE_PATH, f"user_runs4/baseline_{current_time}")
    ...
    for epoch in range(num_epochs):
        ...
        for images, labels in train_loader:
            ...
            # Apply Mixup / CutMix augmentation to the batch before the forward pass
            ...
            # Handle both hard labels (standard) and soft labels (e.g., from MixUp)
