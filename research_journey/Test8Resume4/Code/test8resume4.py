...
PRETRAINED_WEIGHT_PATH = os.path.abspath(os.path.join(current_dir, "..", "..", "TestResume3", "user_weights", "user_best_model_12.pth"))
...
def main():
    ...
    log_dir = f"runs12/baseline_{current_time}"
