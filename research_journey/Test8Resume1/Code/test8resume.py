...
def main():
    ...
    # Lighter augmentation compared to previous versions: same pipeline but
    # Mixup/CutMix strength is reduced, as this is a fine-tuning stage
    ...
    # Significantly reduced strength (mixup_alpha=0.2, cutmix_alpha=0.4, prob=0.4)
    # compared to earlier versions — appropriate for fine-tuning a converged model
    mixup_fn = Mixup(
        mixup_alpha=0.2,
        cutmix_alpha=0.4,
        prob=0.4,
    ...
    # previous training run (PRETRAINED_WEIGHT_PATH) and starts fresh training
