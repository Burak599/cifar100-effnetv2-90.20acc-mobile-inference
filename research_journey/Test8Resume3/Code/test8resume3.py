...
PRETRAINED_WEIGHT_PATH = os.path.abspath(os.path.join(current_dir, "..", "..", "TestResume2", "user_weights", "user_best_model_10.pth"))
...
def main():
    ...
    log_dir = f"runsUser11/baseline_{current_time}"
